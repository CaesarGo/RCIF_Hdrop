...
net = MobileNetV2()
#net = ResNet50()
#model_path = './checkpoint/ckpt_test_res50.pth'
...
# mobilenet
handle = net.layers[12].register_forward_hook(mask_hook_get_information)
net.layers[12].register_forward_hook(mask_hook_fill)

#resnet
# handle = net.layer3.register_forward_hook(mask_hook_get_information)
# net.layer3.register_forward_hook(mask_hook_fill)
